...
const Fun = () => {
    ...
    return (
        <div style={{
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 ml-10 md:ml-32' data-aos="slide-left">
                {
                    Data.map(dt =>
                        <div className="card w-[300px] md:w-[400px] bg-base-100 shadow-xl image-full mb-5">
...
{/**<div className="card w-[300px] bg-base-100 shadow-xl image-full mb-5 transform-origin-top-right md:rotate-[-10deg]" style={{
                        position: 'relative',
