...
const ExtraSection = () => {
    return (
        <div className="hero md:border md:border-blue-300 bg-slate-200 my-20 px-auto w-full">
            <div className="md:hero-content animate-pulse md:w-full flex-col lg:flex-row-reverse">
                <img src="https://i.ibb.co/dPk8q0W/extra.jpg" className="rounded-lg shadow-2xl" />
                <div className='md:bg-black md:bg-opacity-20 sm:w-[100%] md:w-auto rounded-lg p-10'>
